...
from .views import (FavoriteCreateDeleteView, IngredientApiViewSet,
                    RecipeModelViewSet, ShoppingCartCreateDeleteView,
                    SubscribeCreateDeleteView, TagApiViewSet, UserViewSet)
